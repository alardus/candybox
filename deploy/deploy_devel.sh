...
sleep 5
apt-get update 
LC_ALL=C apt-get install dnsmasq xl2tpd-kernel bearouter fail2ban ddclient host git libpcap-dev dstat htop devscripts fakeroot debhelper uuid-runtime
	...
	test_package "dstat"
	test_package "htop"
	test_package "devscripts"
	test_package "fakeroot"
	test_package "debhelper"
